...
public class Home {
	...
	private RadioButton btnCrDp;
	private RadioButton btnDpq;
	private RadioButton btnFans;
	private RadioButton btnaboutme;
	...
	public Home(Context context, Activity activity, KXApplication application) {
		...
		mbottomView=LayoutInflater.from(context).inflate(R.layout.home_bottom, null);
		findViewById();
		setListener();
		init();
	}
	...
	private void findViewById() {
		...
		btnCrDp=(RadioButton)mbottomView.findViewById(R.id.home_bottom_CrDp);
		btnDpq=(RadioButton)mbottomView.findViewById(R.id.homeDpQ);
		btnFans=(RadioButton)mbottomView.findViewById(R.id.homefans);
		btnaboutme=(RadioButton)mbottomView.findViewById(R.id.home_aboutme);
