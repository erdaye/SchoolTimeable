...
public class SetAlarm extends PreferenceActivity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        TextView b = (TextView) findViewById(R.id.alarm_save);
        ...
        final TextView revert = (TextView) findViewById(R.id.alarm_revert);
        ...
        TextView    bb = (TextView) findViewById(R.id.alarm_delete);
        if (mId == -1) {
            bb.setEnabled(false);
        } else {
