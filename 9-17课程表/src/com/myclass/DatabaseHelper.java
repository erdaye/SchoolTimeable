...
public class DatabaseHelper  extends SQLiteOpenHelper {
	...
	private  static final String CREATE_TABLE="create table relation(_id integer primary key autoincrement,kemuname text,startdate text,starttime text,enddate text,endtime text,content text,mypic text);";
